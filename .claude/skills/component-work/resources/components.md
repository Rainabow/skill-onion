...
- OnionHeroSection: 양파 인터랙션 히어로 섹션 루트. h1 상단 풀너비 / 양파 화면 중앙 절대 배치 / 스킬 패널 양파 좌우 / 서브텍스트 하단 중앙. OnionVisualization + SkillRevealPanel + CursorFollower(양파 영역 한정) 조합, 사운드 토글/리셋 포함 (`components/templates/OnionHeroSection.jsx`)
