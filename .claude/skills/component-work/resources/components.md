...
- OnionVisualization: Three.js + @react-three/fiber 기반 3D 양파. SphereGeometry scale [1,1.28,1], 레이어별 MeshStandardMaterial, 껍질 peel 애니메이션 (`components/media/OnionVisualization.jsx`)
...
- OnionHeroSection: 양파 인터랙션 히어로 섹션 루트. OnionVisualization + SkillRevealPanel + LayerProgressBar + CursorFollower 조합, 사운드 토글/리셋 포함 (`components/templates/OnionHeroSection.jsx`)
